...
function Others() {
  ...
  return (
    ...
    <div id="Others" data-aos="fade" className="flex flex-col justify-center items-center md:flex-row md:gap-5 md:scrollbar-hide md:items-stretch lg:gap-5 md:justify-start md:overflow-visible md:overflow-y-hidden">
    {others.map(prod => (
