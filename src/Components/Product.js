...
function Product() {
  ...
  return (
    ...
    <div id="News" data-aos="fade" className="flex flex-col justify-center items-center md:flex-row md:gap-5 md:scrollbar-hide md:items-stretch lg:gap-5 md:justify-start md:overflow-visible md:overflow-y-hidden">
    {products.map(prod => (
     
        
        <div key={prod.id} className=" flex flex-col gap-3 mt-5 md:w-72 h-contain shrink-0">
